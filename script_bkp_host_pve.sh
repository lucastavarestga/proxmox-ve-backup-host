...
/usr/sbin/qm list | grep running > "$PASTA_DIA/qm_list_running_-$DATA_HOJE"_"$HORA_AGORA.txt"  
/usr/sbin/qm list | grep stopped > "$PASTA_DIA/qm_list_stopped_-$DATA_HOJE"_"$HORA_AGORA.txt"
